...
## **1. Relationship to Apple's terms**
...
## **3. Your safety — please read**

Stepper helps you plan and track walks. **You are responsible for your own safety.**

- Pay attention to your surroundings. Do not look at your phone while crossing roads or in situations where you need to watch where you are going.
- Follow traffic rules, signs, private-property boundaries and local laws.
- Routes are calculated automatically from map data. They may pass through paths that are closed, unsafe, unlit, unsuitable for your abilities, or not walkable. Check the route and use your own judgment. Don't use the App in conditions that are dangerous for you.
- Consider weather, time of day and your physical condition before you walk.

## **4. Estimates, not medical advice**
